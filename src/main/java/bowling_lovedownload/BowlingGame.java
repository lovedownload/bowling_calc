...
public class BowlingGame {
	...
	private int[] pin = new int[24];                    // pins knocked down for each roll
	private int strike = 0;                             // strike counter
	private int spare = 0;                              // spare indicator
	private int score = 0;                              // accumulated score
	//private int lastI = 0;
	private int lastJ = 0;                              // index of last roll
	private String pin_value = "";                      // pin display string
	private String score_value = "";                    // score display string
	private Scanner clearpin = new Scanner(System.in);  // input scanner
